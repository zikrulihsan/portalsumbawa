      ...
      <Box mx={4} pt={8}>
        ...
        {searchQuery == "" ?
          ...
          <Box mt={4} p={4} textAlign="center">
            ...
            <Button px="4" fontSize="12" rightIcon={<FaArrowRight/>} size={"sm"} onClick={()=> onGotoExternalLink(whatsappLinkNotFound)} colorScheme="teal">Minta Bantuan Tim Portal, Gratis!</Button>
          </Box> }
          </Box>
        }</Box> }
